...
button1.addEventListener('click', () => {
    button2.style.border = window.getComputedStyle(button1).getPropertyValue('border');
    button1.style.border = window.getComputedStyle(button2).getPropertyValue('border');
